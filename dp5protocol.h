...
enum TRANSMIT_PACKET_TYPE {
    ...
    XMTPT_SEND_SPECTRUM_STATUS_AND_CLEAR,
...
typedef struct _Packet_In {
    unsigned char PID1;
    unsigned char PID2;
    USHORT LEN;  // signed, but data payload always less than 32768
...
public:
    ...
    //bool SendPacketUSB(unsigned char Buffer[], unsigned char PacketIn[]);
